...
function DataTable(param) {
    let { columns, data, searchKey, searchPlaceholder = "Search...", isLoading, page = 1, totalPages = 1, onPageChange, toolbar, onRowClick } = param;
    _s();
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DataTable.useMemo[filtered]": ()=>{
            if (!searchKey || !search) return data;
            return data.filter({
                "DataTable.useMemo[filtered]": (row)=>{
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    const value = row[searchKey];
                    return String(value !== null && value !== void 0 ? value : "").toLowerCase().includes(search.toLowerCase());
                }
            }["DataTable.useMemo[filtered]"]);
        }
    }["DataTable.useMemo[filtered]"], [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                            children: isLoading ? Array.from({
                                length: 5
                                    ...
                                    lineNumber: 92,
                                    columnNumber: 17
                                }, this)) : filtered.length ? filtered.map((row, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
...
_s(DataTable, "8RvJOtcA7wsMv9nUsukBJ4lR+fI=");
_c = DataTable;
var _c;
...
"[project]/app/(dashboard)/contact/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ContactPage() {
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$contact$2d$requests$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContactRequests"])({
        page
    });
    ...
    const columns = [
        {
            ...
            header: "User",
            cell: (req)=>{
                var _req_user, _req_user1, _req_user2, _req_user3, _req_user4;
                var _req_user_fullName, _ref, _req_user_fullName1, _ref1;
                return ((_req_user = req.user) === null || _req_user === void 0 ? void 0 : _req_user.id) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/users/".concat(req.user.id),
                    className: "text-sm text-blue-600 hover:underline font-medium",
                    onClick: (e)=>e.stopPropagation(),
                    children: (_ref = (_req_user_fullName = (_req_user1 = req.user) === null || _req_user1 === void 0 ? void 0 : _req_user1.fullName) !== null && _req_user_fullName !== void 0 ? _req_user_fullName : (_req_user2 = req.user) === null || _req_user2 === void 0 ? void 0 : _req_user2.email) !== null && _ref !== void 0 ? _ref : "#".concat(req.user.id)
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/contact/page.tsx",
                    lineNumber: 38,
                    columnNumber: 11
                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-sm text-muted-foreground",
                    children: (_ref1 = (_req_user_fullName1 = (_req_user3 = req.user) === null || _req_user3 === void 0 ? void 0 : _req_user3.fullName) !== null && _req_user_fullName1 !== void 0 ? _req_user_fullName1 : (_req_user4 = req.user) === null || _req_user4 === void 0 ? void 0 : _req_user4.email) !== null && _ref1 !== void 0 ? _ref1 : "Unknown"
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/contact/page.tsx",
                    lineNumber: 46,
                    columnNumber: 11
        ...
        },
        {
            key: "subject",
            header: "Subject",
            cell: (req)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        ...
        },
        {
            key: "cc",
            header: "CC",
            cell: (req)=>req.cc ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-sm text-muted-foreground",
                    children: req.cc
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/contact/page.tsx",
        ...
        },
        {
            ...
            header: "Attachment",
            cell: (req)=>{
                var _req_attachmentFile, _req_attachmentFile_mimetype, _req_attachmentFile1, _req_attachmentFile2;
                const url = (_req_attachmentFile = req.attachmentFile) === null || _req_attachmentFile === void 0 ? void 0 : _req_attachmentFile.url;
                var _req_attachmentFile_filename;
                return url ? ((_req_attachmentFile1 = req.attachmentFile) === null || _req_attachmentFile1 === void 0 ? void 0 : (_req_attachmentFile_mimetype = _req_attachmentFile1.mimetype) === null || _req_attachmentFile_mimetype === void 0 ? void 0 : _req_attachmentFile_mimetype.startsWith("image/")) ? // eslint-disable-next-line @next/next/no-img-element
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    src: url,
                    alt: (_req_attachmentFile_filename = (_req_attachmentFile2 = req.attachmentFile) === null || _req_attachmentFile2 === void 0 ? void 0 : _req_attachmentFile2.filename) !== null && _req_attachmentFile_filename !== void 0 ? _req_attachmentFile_filename : "attachment",
                    className: "w-12 h-12 object-cover rounded border cursor-pointer hover:opacity-90",
                    onClick: (e)=>{
                        var _req_attachmentFile, _req_attachmentFile1;
                        e.stopPropagation();
                        setAttachmentPreview({
                            url,
                            filename: (_req_attachmentFile = req.attachmentFile) === null || _req_attachmentFile === void 0 ? void 0 : _req_attachmentFile.filename,
                            mimetype: (_req_attachmentFile1 = req.attachmentFile) === null || _req_attachmentFile1 === void 0 ? void 0 : _req_attachmentFile1.mimetype
                        });
                    }
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/contact/page.tsx",
        ...
        },
        {
            key: "createdAt",
            header: "Date",
            cell: (req)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-sm text-muted-foreground",
                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(req.createdAt)
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/contact/page.tsx",
                    lineNumber: 128,
                    columnNumber: 9
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    (data === null || data === void 0 ? void 0 : data.total) ? " · ".concat(data.total, " total") : ""
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/(dashboard)/contact/page.tsx",
                                lineNumber: 143,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tables$2f$data$2d$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataTable"], {
                columns: columns,
...
_s(ContactPage, "k4W6TZSq5/jpfnviAfxpi1d9f4o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$contact$2d$requests$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContactRequests"],
...
//# sourceMappingURL=_4b2596b2._.js.map