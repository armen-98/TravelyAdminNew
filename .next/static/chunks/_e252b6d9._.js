    ...
    const columns = [
        {
            ...
            cell: (user)=>{
                ...
                const inits = (_user_fullName = user.fullName) === null || _user_fullName === void 0 ? void 0 : _user_fullName.split(" ").map((n)=>n[0]).join("").slice(0, 2).toUpperCase();
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center gap-3 cursor-pointer",
                    onClick: ()=>router.push("/users/".concat(user.id)),
                    children: [
...
_s(UsersPage, "l/KxvtqFo32hblDM3HsUt9R0SS8=", false, function() {
    return [
...
//# sourceMappingURL=_e252b6d9._.js.map