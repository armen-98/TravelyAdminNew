...
function LoginPage() {
    ...
    const onSubmit = async (formData)=>{
        var _apiData_user_role, _apiData_user;
        setIsLoading(true);
        setApiError(null);
        // ── Step 1: Call NestJS API directly ─────────────────────────────────────
        let apiData;
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(("TURBOPACK compile-time value", "http://localhost:8000/api"), "/auth/sign-in"), {
            ...
            const error = err;
            const raw = (_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message;
            const message = Array.isArray(raw) ? raw[0] : raw !== null && raw !== void 0 ? raw : "Unable to connect to the server. Please try again.";
            setApiError(message);
        ...
        var _apiData_user_role_name;
        // ── Step 2: Role gate ─────────────────────────────────────────────────────
        const role = (_apiData_user_role_name = (_apiData_user = apiData.user) === null || _apiData_user === void 0 ? void 0 : (_apiData_user_role = _apiData_user.role) === null || _apiData_user_role === void 0 ? void 0 : _apiData_user_role.name) !== null && _apiData_user_role_name !== void 0 ? _apiData_user_role_name : "user";
        if (![
            "admin",
            "super-admin"
        ].includes(role)) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Welcome back, ".concat(apiData.user.fullName, "!"));
        router.push("/");
        router.refresh();
    };
...
_s(LoginPage, "puOdG4za8L64JdKzt26Rh3Fo1a8=", false, function() {
    return [
