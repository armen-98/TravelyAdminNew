...
"[project]/hooks/use-files.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useFiles() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useFiles.useQuery": async ()=>{
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/files/my");
                return Array.isArray(data) ? data : data.data;
            }
        }["useFiles.useQuery"]
    });
}
_s(useFiles, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
...
function useUploadFile() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useUploadFile.useMutation": async (param)=>{
                let { file, folder } = param;
                const formData = new FormData();
                formData.append("file", file);
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/files".concat(folder ? "?folder=".concat(folder) : ""), formData, {
                    headers: {
        ...
        onError: {
            "useUploadFile.useMutation": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to upload file")
        }["useUploadFile.useMutation"]
    });
}
_s1(useUploadFile, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
...
function useDeleteFile() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useDeleteFile.useMutation": async (id)=>{
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("/files/".concat(id));
                return data;
            }
        ...
        onError: {
            "useDeleteFile.useMutation": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete file")
        }["useDeleteFile.useMutation"]
    });
}
_s2(useDeleteFile, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-files.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
...
function FilesPage() {
    ...
    const { data: files, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFiles"])();
    const upload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUploadFile"])();
    const deleteFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeleteFile"])();
    const onDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FilesPage.useCallback[onDrop]": async (acceptedFiles)=>{
            setUploading(true);
            try {
    ...
    const isImage = (file)=>{
        var _file_mimetype;
        return (_file_mimetype = file.mimetype) === null || _file_mimetype === void 0 ? void 0 : _file_mimetype.startsWith("image/");
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
        children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    files ? " · ".concat(files.length, " files") : ""
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/(dashboard)/files/page.tsx",
                                lineNumber: 83,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...getRootProps(),
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-colors", isDragActive ? "border-primary bg-primary/5" : "border-border hover:border-primary/50 hover:bg-muted/30"),
                children: [
            ...
            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 124,
                columnNumber: 9
            }, this) : files && files.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4",
                children: files.map((file)=>{
                    var _file_mimetype_split_, _file_mimetype;
                    var _file_mimetype_split__toUpperCase;
                                    ...
                                    isImage(file) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                variant: "outline",
                                                className: "text-xs",
                                                children: (_file_mimetype_split__toUpperCase = (_file_mimetype = file.mimetype) === null || _file_mimetype === void 0 ? void 0 : (_file_mimetype_split_ = _file_mimetype.split("/")[1]) === null || _file_mimetype_split_ === void 0 ? void 0 : _file_mimetype_split_.toUpperCase()) !== null && _file_mimetype_split__toUpperCase !== void 0 ? _file_mimetype_split__toUpperCase : "FILE"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/files/page.tsx",
                                                lineNumber: 150,
                                                columnNumber: 21
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDialogDescription"], {
                                    children: [
                                        ...
                                        deleteTarget === null || deleteTarget === void 0 ? void 0 : deleteTarget.filename,
...
_s(FilesPage, "Rpylx6Y9o1pB/JbvVvg6+z4zHIQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFiles"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUploadFile"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$files$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeleteFile"],
...
//# sourceMappingURL=_d648483d._.js.map